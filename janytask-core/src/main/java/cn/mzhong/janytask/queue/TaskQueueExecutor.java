...
public abstract class TaskQueueExecutor<A extends Annotation> extends TaskExecutor {

    final static Logger Log = LoggerFactory.getLogger(TaskQueueExecutor.class);
    ...
    public TaskQueueExecutor(TaskContext context, QueueInfo<A> queueInfo) {
        super(context);
