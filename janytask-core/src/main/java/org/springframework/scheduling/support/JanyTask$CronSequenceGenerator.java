...
public class JanyTask$CronSequenceGenerator {
    ...
    /**
     * Get the next {@link Date} in the sequence matching the Scheduled pattern and
    ...
    private void setDaysOfMonth(BitSet bits, String field) {
        int max = 31;
        // Days of month start with 1 (in Scheduled and Calendar) so add one
    ...
    private void setMonths(BitSet bits, String value) {
        ...
        // Months start with 1 in Scheduled and 0 in Calendar, so push the values first into a longer bit set
